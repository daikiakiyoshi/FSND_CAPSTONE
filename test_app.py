...
class AssetManagementSystemTestCase(unittest.TestCase):
    ...
    def test_retrieve_portfolios(self):
        res = self.client().get(
            '/portfolios',
            headers={
                'Authorization': 'Bearer ' + self.fund_manager})
    ...
    def test_create_portfolio(self):
        new_portfolio = {"portfolio_name": "TEST_PORT", "portfolio_compositions": [
            {"security_id": 1, "weight": 60}, {"security_id": 2, "weight": 40}]}
    ...
    def test_analyst_401_create_portfolio(self):
        ...
        res = self.client().post(
            ...
            json=new_portfolio,
            headers={
                'Authorization': 'Bearer ' + self.analyst})
        data = json.loads(res.data)
    ...
    def test_422_create_portfolio(self):
        ...
        new_portfolio = {"portfolio_name": "TEST_PORT", "portfolio_compositions": [
            {"security_id": 1, "weight": 100}, {"security_id": 2, "weight": 100}]}
        res = self.client().post(
            '/portfolios',
            json=new_portfolio,
            headers={
    ...
    def test_update_portfolio(self):
        update_portfolio = {"portfolio_name": "TEST_PORT3", "portfolio_compositions": [
            {"security_id": 1, "weight": 50}, {"security_id": 2, "weight": 50}]}
        portfolio_update_id = 3
        res = self.client().patch(
            '/portfolios/{}'.format(portfolio_update_id),
    ...
    def test_analyst_create_security(self):
        ...
        new_security = {
            "security_name": "TEST_SECURITY_analyst",
            "region_id": 1,
            "asset_class_id": 1}
        res = self.client().post(
            '/securities',
    ...
    def test_assistant_401_create_security(self):
        ...
        new_security = {
            "security_name": "TEST_SECURITY_assistant",
            "region_id": 1,
            "asset_class_id": 1}
        res = self.client().post(
            '/securities',
    ...
    def test_update_security(self):
        update_security = {
            "security_name": "TEST_SECURITY3",
            "region_id": 1,
            "asset_class_id": 1}
        security_update_id = 3
        res = self.client().patch(
            '/securities/{}'.format(security_update_id),
            json=update_security,
            headers={
                'Authorization': 'Bearer ' + self.fund_manager})
        data = json.loads(res.data)
